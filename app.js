...
(() => {
  ...
  function initialize() {
    ...
    window.addEventListener('storage', renderAll); document.addEventListener('visibilitychange', () => { if (!document.hidden) renderAll(); }); window.addEventListener('focus', renderAll);
